package com.web.baebaeBE.domain.member.controller.api;
...
public interface MemberApi {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "조회 성공",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = MemberResponse.MemberInformationResponse.class))),
    ...
    ResponseEntity<MemberResponse.MemberInformationResponse> getMemberInformation(@PathVariable Long id);
    ...
    ResponseEntity<MemberResponse.MemberIdResponse> getMemberIdByNickname(@PathVariable String nickname);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "조회 성공",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = MemberResponse.ProfileImageResponse.class))),
            @ApiResponse(responseCode = "401", description = "토큰 인증 실패",
                    content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(value = "{\n" +
                                    "  \"errorCode\": \"T-002\",\n" +
    ...
    ResponseEntity<MemberResponse.ProfileImageResponse> getProfileImage(
    ...
    ResponseEntity<MemberResponse.ProfileImageResponse> updateProfileImage(@PathVariable Long id,
